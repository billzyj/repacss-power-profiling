#!/usr/bin/env python3
"""
Shared configuration management for REPACSS power profiling.
"""
...
class Config:
    ...
    def __post_init__(self):
        ...
        if self._database_schemas is None:
            self._database_schemas = {
                "h100": {"schemas": ["public", "idrac", "slurm"], "default_schema": "idrac"},
                "zen4": {"schemas": ["public", "idrac", "slurm"], "default_schema": "idrac"},
                "infra": {"schemas": ["public", "irc", "pdu"], "default_schema": "pdu"},
            }
    ...
    def load_from_env_file(self, env_file_path: str = None):
        if env_file_path is None:
            ...
            candidates = [
                repo_root / ".env",
                repo_root / "src" / "database" / "config" / ".env",
            ]
